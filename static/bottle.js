var textContainer0 = document.querySelector('#bottle-path-container');
var textContainer1 = document.querySelector('#bottle-path-container1');
const topElement = document.getElementById('header');
const bottomElement = document.getElementById('end-index');
...
function setPathHeight() {
    ...
    textContainer0.style['height'] = `${pathBottomY-pathTopY}px`;
...
var textPath0 = document.getElementById('bottle');
var textPath1 = document.getElementById('bottle1');

var path0 = document.querySelector( textPath0.getAttribute('href') );
var path1 = document.querySelector( textPath1.getAttribute('href') );

var pathLength = path0.getTotalLength();

function updateTextPathOffset(offset){
  textPath0.setAttribute('startOffset', offset);
...
function bottleScroll(){
  requestAnimationFrame(function(){
    ...
    var rect = textContainer0.getBoundingClientRect();
